# Picovoice SDK for Arduino boards - Farsi language
...
1. Compile and upload the `Picovoice_FA/GetUUID` sketch from the `File -> Examples` menu. Copy the UUID of the board
